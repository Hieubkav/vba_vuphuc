...
<div x-data="webDesignBuilder()" class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">📋 Danh sách Sections</h3>
            <div class="flex items-center space-x-4">
                <div class="text-sm text-gray-600 dark:text-gray-400">
                    <span x-text="enabledSections"></span>/<span x-text="totalSections"></span> sections đang hiển thị
                </div>
                <button 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="bg-red-25">❤️ Đỏ nhạt</option>
