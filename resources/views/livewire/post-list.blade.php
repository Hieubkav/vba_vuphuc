            ...
            <div class="filter-card rounded-xl p-6">
                ...
                <div class="relative">
                    <input type="text"
                           ...
                           placeholder="Tiêu đề bài viết, nội dung...">
            ...
            <div class="filter-card rounded-xl p-6">
                ...
                <div class="space-y-2">
                    ...
                    <button wire:click="$set('category', '{{ $cat->slug }}')"
                        ...
                        <span>{{ $cat->name }}</span>
                        <span class="text-xs bg-gray-200 text-gray-600 px-2 py-1 rounded-full">{{ $cat->posts_many_count ?? 0 }}</span>
                    </button>
                    @endforeach
                </div>
            </div>
            ...
            <div class="filter-card rounded-xl p-6">
                ...
                <div class="space-y-2">
                    ...
                    <button wire:click="$set('sort', 'oldest')"
                            class="w-full text-left px-3 py-2 rounded-lg transition-colors font-open-sans {{ $sort === 'oldest' ? 'bg-red-100 text-red-700 font-medium' : 'hover:bg-gray-50' }}">
                        Cũ nhất
                    </button>
                    <button wire:click="$set('sort', 'featured')"
                            class="w-full text-left px-3 py-2 rounded-lg transition-colors font-open-sans {{ $sort === 'featured' ? 'bg-red-100 text-red-700 font-medium' : 'hover:bg-gray-50' }}">
                        Nổi bật
                    </button>
                </div>
            </div>
    ...
    <main class="flex-1 min-w-0 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-md border border-red-100 p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex items-center space-x-3 bg-red-50 px-4 py-2 rounded-lg">
                    ...
                    <span class="text-sm font-medium text-red-700 font-open-sans">bài viết</span>
                </div>
            </div>
        </div>
        ...
        <div wire:loading.delay class="text-center py-8">
            <div class="inline-flex items-center px-6 py-3 bg-red-100 text-red-800 rounded-xl shadow-md">
                ...
                <span class="font-medium font-open-sans">Đang tải bài viết...</span>
            </div>
        </div>
